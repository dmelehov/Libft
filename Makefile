...
#    Updated: 2016/12/20 16:34:13 by dmelehov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCO = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
    ...
    ft_lstnew.o ft_lstadd.o ft_lstiter.o ft_lstdelone.o ft_lstdel.o ft_lstmap.o \
    ft_realloc.o ft_append.o \
